...
<html lang="de">
	...
	<body>
		...
		<p>Möglicherweise existiert diese Seite nicht mehr, um alte Versionen zu finden schauen sie bitte <a href="https://web.archive.org/web/*/https://computexnow.com" target="_blank">hier</a>.</p>
		<p>Wenn Sie glauben das ist ein Fehler, dann schreiben Sie un eine Email: <a href="mailto:computex.kontakt@gmail.com">hier</a>.</p>
		</div>
		<div class="D"></div>
