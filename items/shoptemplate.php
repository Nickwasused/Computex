...
<head>
	...
	<meta name="description" content="Computex Shop: ">
	...
	<meta name="twitter:description" content="Computex Shop: ">
...
<body>
	<div class="grid">
		...
		<div class="C">
			<div class="shopgrid">
				<div class="G"><center><img id="main" src="img/cpu0/cpu0.png"></center></div>
				<div class="I"><center><img id="small" src="img/cpu0/cpu0.png"></center></div>
