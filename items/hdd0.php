...
<html lang="de">
<head>
	<title>Computex | Western Digital WD Red 4TB</title>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width,initial-scale=1">
	<meta name="description" content="Computex Shop: Western Digital WD Red 4TB">
	...
	<meta name="twitter:description" content="Computex Shop: Western Digital WD Red 4TB">
	...
	<div class="grid">
		...
		<div class="desktoponly">
			<video autoplay muted loop id="myVideo">
					<source src="vid/wd_red/wd_red.webm" type="video/webm" >
					<source src="vid/wd_red/wd_red.mp4" type="video/mp4">
					<source src="vid/wd_red/wd_red.wmv" type="video/wmv">
					<source src="vid/wd_red/wd_red.flv" type="video/flv">
			</video>
		</div>
			<div class="shopgrid">
				<div class="G">
					...
					<div class="preview" align="center">
						<img name="preview" src="img/hdd0/hdd0.png" alt=""/>
					</div>

						<div class="thumbnails">
							<img onmouseover="preview.src=img1.src" name="img1" src="img/hdd0/hdd0.png" alt="" />
							<img onmouseover="preview.src=img2.src" name="img2" src="img/hdd0/hdd1.png" alt="" />
							<img onmouseover="preview.src=img3.src" name="img3" src="img/hdd0/hdd2.png" alt="" />
							<img onmouseover="preview.src=img4.src" name="img4" src="img/hdd0/hdd3.png" alt="" />
						</div>
				</div>
				</div>
				<div class="H"><h2>Western Digital WD Red 4TB,3.5",SATA 6GB/s (WD40EFRX)</h2>
				<ul id="normal" type="square">
					<li>Formfaktor: 3.5"</li><br>
					<li>Drehzahl: 5400rpm</li><br>
					<li>Cache: 64MB</li><br>
					<li>Leistungsaufnahme: 4.5W (Betrieb), 3.3W (Leerlauf)</li><br>
					<li>Lautst&auml;rke: 28dB(A) (Betrieb), 25dB(A) (Leerlauf)</li><br>
					<li>Aufnahmeverfahren: Perpendicular Magnetic Recording (PMR)</li><br>
					<li>Sektoren: 4KB mit Emulation (512e)</li><br>
					<li>MTBF: 1 Mio. Stunden</li><br>
					<li>Verschl&uuml;sselung: N/A</li><br>
					<li>Besonderheiten: geeignet f&uuml;r Dauerbetrieb</li>
				</ul>
				<br>
				<p id="price">Preis: 110&euro;</p>
				<form method='post' action=''>
				<button type='submit' class='buy'>Jetzt kaufen</button>
				<input type='hidden' name='code' value='hdd0' />
				</form>
			</div>
			</div>
		</div>
