...
<html lang="de">
<head>
	<title>Computex | be quiet&#33; Pure Base 500 schwarz</title>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width,initial-scale=1">
	<meta name="description" content="Computex Shop: be quiet&#33; Pure Base 500 schwarz">
	...
	<meta name="twitter:description" content="Computex Shop: be quiet&#33; Pure Base 500 schwarz">
			...
			<div class="shopgrid">
				<div class="G">
					...
					<div class="preview" align="center">
						<img name="preview" src="img/case1/case0.png" alt=""/>
					</div>

						<div class="thumbnails">
							<img onmouseover="preview.src=img1.src" name="img1" src="img/case1/case0.png" alt="" />
							<img onmouseover="preview.src=img2.src" name="img2" src="img/case1/case1.png" alt="" />
							<img onmouseover="preview.src=img3.src" name="img3" src="img/case1/case2.png" alt="" />
							<img onmouseover="preview.src=img4.src" name="img4" src="img/case1/case3.png" alt="" />
						</div>
				</div>
				</div>
				<div class="H"><h2>be quiet&#33; Pure Base 500 schwarz, Glasfenster, schallged&auml;mmt (BGW34)</h2>
				<ul id="normal" type="square">
					<li>Extern	N/​A</li><br>
					<li>Intern	1x 2.5"/3.5" (quer, Festplattenk&auml;fig), 1x 3.5" (quer, Festplattenk&auml;fig), 4x 2.5"</li><br>
					<li>Front I/O	2x USB-A 3.0, 1x Kopfh&ouml;rer, 1x Mikrofon</li><br>
					<li>PCI-Steckpl&auml;tze	7</li><br>
					<li>L&uuml;fter (vorne)	1x 140mm, 900rpm oder 2x 140mm (optional) oder 3x 120mm (optional)</li><br>
					<li>L&uuml;fter (hinten)	1x 140mm, 900rpm</li><br>
					<li>L&uuml;fter (links)	N/​A</li><br>
					<li>L&uuml;fter (rechts)	N/​A</li><br>
					<li>L&uuml;fter (oben)	2x 140mm (optional) oder 2x 120mm (optional)</li><br>
					<li>L&uuml;fter (unten)	N/​A</li><br>
					<li>L&uuml;fter (sonstige)	N/​A</li><br>
					<li>Radiatorgr&ouml;ßen	120/​140/​240/​280/​360mm vorne, 120/​240mm oben, 120/​140mm hinten</li><br>
				</ul>
				<br>
				<p id="price">Preis: 70&euro;</p>
				<form method='post' action=''>
				<button type='submit' class='buy'>Jetzt kaufen</button>
				<input type='hidden' name='code' value='case1' />
				</form>
			</div>
			</div>
		</div>
