...
<html lang="de">
<head>
	<title>Computex | Scythe Mugen 5 [Rev. B]</title>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width,initial-scale=1">
	<meta name="description" content="Computex Shop: Scythe Mugen 5 [Rev. B]">
	...
	<meta name="twitter:description" content="Computex Shop: Scythe Mugen 5 [Rev. B]">
			...
			<div class="shopgrid">
				<div class="G">
					...
					<div class="preview" align="center">
						<img name="preview" src="img/fan0/fan0.png" alt=""/>
					</div>

						<div class="thumbnails">
							<img onmouseover="preview.src=img1.src" name="img1" src="img/fan0/fan0.png" alt="" />
							<img onmouseover="preview.src=img2.src" name="img2" src="img/fan0/fan1.png" alt="" />
							<img onmouseover="preview.src=img3.src" name="img3" src="img/fan0/fan2.png" alt="" />
							<img onmouseover="preview.src=img4.src" name="img4" src="img/fan0/fan3.png" alt="" />
						</div>
				</div>
				</div>
				<div class="H"><h2>Scythe Mugen 5 [Rev. B] (SCMG-5100)</h2>
				<ul id="normal" type="square">
					<li>Bauart	Tower-K&uuml;hler</li><br>
					<li>Abmessungen	130x155x110mm (BxHxT)</li><br>
					<li>L&uuml;fter	1x 120x120x27mm, 300-1200rpm, 28.2-86.93m³/​h, 4-24.9dB(A)</li><br>
					<li>Gewicht	890g</li><br>
					<li>Anschluss	4-Pin PWM</li><br>
					<li>Sockel	775, 1150, 1151, 1155, 1156, 1366, 2011, 2011-3, 2066, AM2, AM2+, AM3, AM3+, AM4, FM1, FM2, FM2+</li><br>
					<li>Besonderheiten	6 Heatpipes (6mm)</li><br>
				</ul>
				<br>
				<p id="price">Preis: 45&euro;</p>
				<form method='post' action=''>
				<button type='submit' class='buy'>Jetzt kaufen</button>
				<input type='hidden' name='code' value='fan00' />
				</form>
			</div>
			</div>
		</div>
