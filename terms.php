...
<html lang="de">
	...
	<body>
		...
		<div class="C">
			...
			<p>Last updated: February 04, 2020</p>
			...
			<ul>
				  ...
				  <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Computex, Oldenburg i.H.  23758 DEUTSCHLAND.</li>
				  <li><strong>Country</strong> refers to: Schleswig-Holstein, Germany</li>
			  ...
			  <li><strong>Website</strong> refers to Computex, accessible from https://computexnow.com</li>    <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
			</ul>
			...
			<ul>
        <li>By email: computex.kontakt@gmail.com</li>
        </ul>
		</div>
		<div class="D"></div>
