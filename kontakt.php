...
<html lang="de">
	...
	<body>
		...
		<div class="C">
			...
			<p>Kommen sie gerne Persönlich vorbei&#33; Unsere Tür steht Ihnen immer offen.</p>
			<p id="big">Adresse:<br>
			...
			<h2>Per Email</h2>
			<p>Email: computex.kontakt&#64;gmail.com</p>
			<p><a href="mailto:computex.kontakt@gmail.com" target="_blank">Direkt Schreiben</a></p>
			<h2>Social Media</h2>
			<a href="twitter.html">Folge uns auf Twitter!</a>
			<h2>Weitere Informationen</h2>
			<a href="press.html">Hier!</a>
		</div>
		<div class="D"></div>
