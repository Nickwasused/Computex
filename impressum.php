...
<html lang="de">
	...
	<body>
		<div class="grid">
			...
			<div class="B"></div>
			<div class="C"><h1>Impressum</h1>
						   <h2>Kontakt</h2>
						   <p>Kremsdorfer Weg 31</p>
						   <p>Oldenburg i.H.</p>
						   <p>23758</p>
						   <p>Tel: 04361-9080</p>
						   <p>Fax: 04361-908118</p>
						   <h2>Vertreten durch:</h2>
						   <p>Geschäftsführer D.U.</p>
						   <p>Geschäftsführer D.S.</p>
						   <h2>Umsatzsteuer-ID:</h2>
						   <p>Umsatzsteuer-Identifikationsnummer nach §27a Umsatzsteuergesetz: DE847897018</p>
						   <br>
						   <br>
						   <h2>§ 1 Warnhinweis zur Seite</h2>
						   <p>Diese Seite wurde nur zum Zweck einer Prüfung erstellt und keine Informationen auf dieser Seite sind ernst zu nehmen.</p>
						   <p>Bei rechtlichen Fragen wenden sie sich an: Die Berufsschule Oldenburg i.H. (bbs-old.de)</p>
						   <br>
						   <br>
						   <h2>§ 2 Externe Links</h2>
						   <p>Diese Website enthält Verknüpfungen zu Websites Dritter ("externe Links"). Diese Websites unterliegen der Haftung der jeweiligen Betreiber. 
						   Der Anbieter hat bei der erstmaligen Verknüpfung der externen Links die fremden Inhalte daraufhin überprüft, ob etwaige Rechtsverstö&szlig;e bestehen. 
						   Zu dem Zeitpunkt waren keine Rechtsverstö&szlig;e ersichtlich. Der Anbieter hat keinerlei Einfluss auf die aktuelle und zukünftige Gestaltung und auf die Inhalte der verknüpften Seiten. 
						   ...
						   Eine ständige Kontrolle der externen Links ist für den Anbieter ohne konkrete Hinweise auf Rechtsverstö&szlig;e nicht zumutbar. 
						   Bei Kenntnis von Rechtsverstö&szlig;en werden jedoch derartige externe Links unverzüglich gelöscht.</p>
						   <br>
						   <br>
						   <h2>§ 3 Urheber- und Leistungsschutzrechte</h2>
						   <p>Die Darstellung dieser Website in fremden Frames ist nicht zulässig.</p>
						   	<br>
						   <br>
						   <h2>§ 4 Lizenz</h2>
						   <p>Lizenz: <a href="LICENSE">LICENSE</a></p>
		</div>
		<div class="D"></div>
