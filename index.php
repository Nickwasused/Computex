...
<html lang="de">
	...
	<body>
		<div class="grid">
			...
			<div class="B"></div>
			<div class="C">
				<center><h1>Willkommen auf der Website von&#58; Computex&#33;</h1></center>
				<br>
				<br>
				<center><div class="alert">&#x2623;Aufgrund des Corona Virus kann es zu l&auml;ngeren Lieferzeiten kommen. Wir bitten dies zu entschuldigen! &num;StayAtHome &#x1f3da;</div></center>
				<ul id="normal">
					<h2 id="underlined">Was wir Anbieten&#58;</h2>
					<li>
						<p>Wir bieten viele verschiedene <a id="embed" href="dienstleistungen.html">Dienstleistungen</a> an wie z.B. die Einrichtung von EDV-Systemen in Ihrer Firma.</p>
					</li>
					<br>
					<li>
						<p>Ausstattung wie B&uuml;rostuhle, Tische und Komplett-Systeme können Sie sich in unserer Filiale in Oldenburg i.H. angucken.</p>
					</li>
					<br>
					<li>
						<p>Au&szlig;erdem finden Sie etwas weiter unten unseren Online Shop für verschiedenste Computer-Teile.</p>
					</li>
				</ul>
				<br>
				<br>
				<h2>Unseren Shop findest du <a href="shop.php">hier</a>&#33;</h2>
			</div>
		<div class="D"></div>
