		...
		<div class="C">
			<h1>Unsere Logos</h1>
				...
				<div class="thumbnails">
					<a href="logo.svg" target="_blank"><img src="logo.svg" alt="" /></a>
					<a href="logos/logo-1.png" target="_blank"><img src="logos/logo-1.png" alt="" /></a>
					<a href="logos/logo-2.png" target="_blank"><img src="logos/logo-2.png" alt="" /></a>
					<a href="logos/twitter-banner.png" target="_blank"><img src="logos/twitter-banner.png" alt="" /></a>
					<a href="logos/youtube-banner.png" target="_blank"><img src="logos/youtube-banner.png" alt="" /></a>
				</div>
			</div>
			<h1>Designvorgaben</h1>
			<div>
			<h2>Hauptfarbe</h2>
			<p>#821bdc</p>
			<svg width="100" height="100">
				<circle cx="50" cy="50" r="40" stroke="black" stroke-width="4" fill="#821bdc" />
			</svg>
			</div>
			<div>
			<h2>Zweitfarbe-hell</h2>
			<p>white</p>
			<svg width="100" height="100">
			...
			<div>
			<h2>Zweitfarbe-dunkel</h2>
			<p>#18181b</p>
			<svg width="100" height="100">
				<circle cx="50" cy="50" r="40" stroke="black" stroke-width="4" fill="#18181b" />
			</svg>
			</div>
			<h2>Unser Quellcode</h2>
			<a href="https://github.com/Nickwasused/Computex" target="_blank">Hier!</a>
		</div>
		<div class="D"></div>
