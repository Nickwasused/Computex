...
<html lang="de">
	...
	<body>
		...
		<div class="B"></div>
		<div class="C">
			<center><h1>Unsere Firma</h1></center>
			<center><h2 id="underlined">Hier finden Sie ein parr Bilder von unserer Firma.</h2></center>
			<br>
			<p class="underlined">Unser Konferenz und Schulungsraum</p>
			<div id="gallery">
				<div class="thumbnails">
					<a href="img/wir/kon0.php" target="_blank"><img src="img/wir/kon0-min.svg" alt="" /></a>
					<a href="img/wir/kon3.php" target="_blank"><img src="img/wir/kon3-min.svg" alt="" /></a>
					<a href="img/wir/kon2.php" target="_blank"><img src="img/wir/kon2-min.svg" alt="" /></a>
					<a href="img/wir/kon1.php" target="_blank"><img src="img/wir/kon1-min.svg" alt="" /></a>
				</div>
			</div>
			<br>
			<p class="underlined">Unser Pausenraum</p>
			<div id="gallery">
				<div class="thumbnails">
					<a href="img/wir/kaf0.php" target="_blank"><img src="img/wir/kaf0-min.svg" alt="" /></a>
					<a href="img/wir/kaf1.php" target="_blank"><img src="img/wir/kaf1-min.svg" alt="" /></a>
				</div>
			</div>
		</div>
		<div class="D"></div>
